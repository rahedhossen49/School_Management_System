            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="pagesDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{route('HomePage.OurStudent')}}">Our Student</a></li>
                        <li><a class="dropdown-item" href="{{route('teacher.dashboard')}}">Teachers</a></li>
                        <li><a class="dropdown-item" href="{{route('student.dashboard')}}">Student</a></li>
